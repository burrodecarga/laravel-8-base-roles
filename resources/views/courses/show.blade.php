<x-app-layout>
    ...
    <div class="container grid grid-cols-3 px-4">
                ...
                <section class="card">
                    ...
                    @endif>
                        <header class="border border-gray-200 px-4 py-2 cursor-pointer text-gray-200" x-on:click="open = ! open">
                            ...
                            <i class="far fa-hand-pointer ml-3" title="push Open <-> Close"></i> <i class="fas fa-sync ml-3"></i> </span></h2>
                        </header>
       ...
       <section class="px-4 py-2 bg-white my-10">
        ...
        </div> <div class="cols-span-1">
            <section class="card">
                <div class="card-body">
                    <div class="flex">
                        <img class="rounded-full shadow-lg h-12 w-12" src="{{$course->teacher->profile_photo_url}}" alt="{{$course->teacher->name}}">
                        <div class="ml-4 flex items-center flex-col">
                            <h2 class="font-bold  text-gray-600 text-lg">{{$course->teacher->name}}</h2>
                            <a class="text-blue-600 text-xs">{{'@'.Str::slug($course->teacher->name,'')}}</a>
                            <a href="#" class="mt-4 w-ful py-3 px-4 bg-blue-600 hover:bg-blue-400 text-white rounded-lg">{{__('Buy Course')}}</a>
                        </div>
                    </div>
                </div>
               </section>
